...
<!--INFO-->
<span style="color: red;">Important: The BlenderNC API has been updated for future development and consistency to support `netCDF`, `Grib`, and `zarr` formats. In other words, this version is not backwards compatible, thus to reproduce previous animations, users are required to update their BlenderNC nodetrees.</span>
