            ...
            if self.inputs[-1].links and self.inputs[0].links:
                ...
                dataset_other = (
                    ...
                    .from_node.blendernc_dict[
                        self.inputs[-1].links[0].from_node.blendernc_dataset_identifier
                    ]
                )
                varname_other = dataset_other["selected_var"]["selected_var_name"]

                dataset = dataset_self["Dataset"][varname_self] + dataset_other[
                    "Dataset"
                ][varname_other].to_dataset(name=varname_self)
