...
from .utils import add_attribute, get_data_from_datastruct, find_coord_matches
...
def bNC_update_attributes(scene):
    ...
    for node in anim_text_nodes:
        ...
        animate_coord = [coord for coord in coords.keys() if coord not in matched_coords][0]
